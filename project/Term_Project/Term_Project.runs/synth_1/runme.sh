...
HD_PWD='C:/Kristian/GitHub/TFE4141/project/Term_Project/Term_Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopLevelStateMachine_tb.vds -m64 -mode batch -messageDb vivado.pb -notrace -source TopLevelStateMachine_tb.tcl
